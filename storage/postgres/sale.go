...
func (r *saleRepo) Create(ctx context.Context, req *models.CreateSale) (*models.Sale, error) {
	...
	var (
		id, branchId, salepointId, shiftId, employeeId, barcode, status, createdAt, updatedAt sql.NullString
	)
...
func (r *saleRepo) GetByID(ctx context.Context, req *models.SalePrimaryKey) (*models.Sale, error) {
	...
	var (
		id, saleId, branchId, salepointId, shiftId, employeeId, barcode, status, createdAt, updatedAt sql.NullString
	)
...
func (r *saleRepo) GetList(ctx context.Context, req *models.GetListSaleRequest) (*models.GetListSaleResponse, error) {
	...
	if len(req.Search) > 0 {
		where += fmt.Sprintf(" AND (sale_id ILIKE '%%%s%%' OR barcode ILIKE '%%%s%%')", req.Search, req.Search)
	}
